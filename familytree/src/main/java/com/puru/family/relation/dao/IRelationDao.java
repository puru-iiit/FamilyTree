package com.puru.family.relation.dao;
...
public interface IRelationDao {
	...
	public IRelationDetails getRelation(IPersonKey firstPersonKey, IPersonKey secondPersonKey,IRelationType relationType)
			throws ApplicationException;
